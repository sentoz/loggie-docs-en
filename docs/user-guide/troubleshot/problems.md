...
## net.cgoLookupIP Causes Segmentation Violation

**Phenomenon**

When using unix sock source, Loggie crashes after startup, and there are the following logs:
...
For specific reasons, please refer to: [go net](https://go.dev/src/net/net.go)。
...
Add environment variables to the Loggie deployment script:
